...
def graph_from_smiles(smiles):
    ...
    for atom in mol.GetAtoms():
        #print("PROBABLY NOT GETTING NEW NODE")
        #print("ATOM FEATURES: {}".format(atom_features(atom)))
        new_atom_node = graph.new_node('atom', features=atom_features(atom), rdkit_ix=atom.GetIdx())
        #print("YUP")
        atoms_by_rd_idx[atom.GetIdx()] = new_atom_node

    #print("CREATED ATOMS BY RD IDX")
...
#             break
        ...
        try:
            ...
            #print("AFTER GRAPH FROM SMILES")
            molgraph.sort_nodes_by_degree('atom')
            #print("AFTER SORTING MOLGRAPH")
            arrayrep = array_rep_from_smiles(molgraph)
            #print("AFTER ARRAY REPRESENTATION")
