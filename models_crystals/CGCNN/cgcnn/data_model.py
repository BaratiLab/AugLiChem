...
def get_train_val_test_loader(dataset, collate_fn=default_collate,
    ...
    # 	idx_correction = num_aug*i 
    # 	add_1 = train_idx[i] + idx_correction + 1
    # 	add_2 = train_idx[i] + idx_correction + 2
    # 	add_3 = train_idx[i] + idx_correction + 3
    # 	add_  = train_idx[i] + idx_correction
...
class CIFData(Dataset):
    ...
    def __init__(self, root_dir, fold = 0, max_num_nbr=12, radius=8, dmin=0, step=0.2,
        ...
        id_prop_file = os.path.join(self.root_dir, 'id_prop_test_{}.csv'.format(fold))
